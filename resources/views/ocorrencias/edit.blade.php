        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Editar Ocorrência</h3>
                </div>
                <div class="card-body">
                    @if($errors->any())
                                    ...
                                    <select class="form-control @error('funcionario_id') is-invalid @enderror" 
                                        ...
                                        @foreach($funcionarios as $funcionario)
                                            <option value="{{ $funcionario->id }}" 
                                                    {{ old('funcionario_id', $ocorrencia->funcionario_id) == $funcionario->id ? 'selected' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('tipo') is-invalid @enderror" 
                                        ...
                                        @foreach(App\Models\Ocorrencias::TIPOS as $key => $value)
                                            <option value="{{ $key }}" 
                                                    {{ old('tipo', $ocorrencia->tipo) == $key ? 'selected' : '' }}>
                                                {{ $value }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('data') is-invalid @enderror" 
                                           id="data" name="data" 
                                           value="{{ old('data', $ocorrencia->data ? $ocorrencia->data->format('Y-m-d') : '') }}" required>
                                    @error('data')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control @error('hora_inicio') is-invalid @enderror" 
                                           ...
                                           value="{{ old('hora_inicio', $ocorrencia->hora_inicio ? $ocorrencia->hora_inicio->format('H:i') : '') }}">
                                    @error('hora_inicio')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control @error('hora_fim') is-invalid @enderror" 
                                           ...
                                           value="{{ old('hora_fim', $ocorrencia->hora_fim ? $ocorrencia->hora_fim->format('H:i') : '') }}">
                                    @error('hora_fim')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.5" class="form-control @error('quantidade_horas') is-invalid @enderror" 
                                           id="quantidade_horas" name="quantidade_horas" 
                                           value="{{ old('quantidade_horas', $ocorrencia->quantidade_horas) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('status') is-invalid @enderror" 
                                        ...
                                        @foreach(App\Models\Ocorrencias::STATUS as $key => $value)
                                            <option value="{{ $key }}" 
                                                    {{ old('status', $ocorrencia->status) == $key ? 'selected' : '' }}>
                                                {{ $value }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('descricao') is-invalid @enderror" 
                                              id="descricao" name="descricao" rows="3">{{ old('descricao', $ocorrencia->descricao) }}</textarea>
                                    @error('descricao')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
