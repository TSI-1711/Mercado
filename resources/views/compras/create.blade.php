        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0">Nova Ordem de Compra</h4>
                </div>
                <div class="card-body">
                    @if($errors->any())
                    ...
                    <form action="{{ route('compras.store') }}" method="POST" id="compraForm">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('data_compra') is-invalid @enderror" 
                                           id="data_compra" name="data_compra" value="{{ old('data_compra', date('Y-m-d')) }}" required>
                                    @error('data_compra')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-check-circle"></i> Criar Ordem de Compra
                            </button>
                        </div>
                    </form>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Configurar eventos para uma linha de item
    function setupItemEvents(row) {
        ...
        // Calcular subtotal quando quantidade ou preço mudar
