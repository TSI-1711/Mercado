                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('rg') is-invalid @enderror" 
                                           id="rg" name="rg" value="{{ old('rg', $funcionario->rg) }}">
                                    @error('rg')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('data_nascimento') is-invalid @enderror" 
                                           ...
                                           value="{{ old('data_nascimento', $funcionario->data_nascimento ? $funcionario->data_nascimento->format('Y-m-d') : '') }}" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('data_admissao') is-invalid @enderror" 
                                           id="data_admissao" name="data_admissao" 
                                           value="{{ old('data_admissao', $funcionario->data_admissao ? $funcionario->data_admissao->format('Y-m-d') : '') }}" required>
                                    @error('data_admissao')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('salario_base') is-invalid @enderror" 
                                           id="salario_base" name="salario_base" value="{{ old('salario_base', $funcionario->salario_base) }}" required>
                                    @error('salario_base')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('valor_hora_extra') is-invalid @enderror" 
                                           id="valor_hora_extra" name="valor_hora_extra" value="{{ old('valor_hora_extra', $funcionario->valor_hora_extra) }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('banco') is-invalid @enderror" 
                                           id="banco" name="banco" value="{{ old('banco', $funcionario->banco) }}">
                                    @error('banco')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('agencia') is-invalid @enderror" 
                                           id="agencia" name="agencia" value="{{ old('agencia', $funcionario->agencia) }}">
                                    @error('agencia')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('conta') is-invalid @enderror" 
                                           id="conta" name="conta" value="{{ old('conta', $funcionario->conta) }}">
                                    @error('conta')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
